...
class RagistrationSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model=User
        fields = ['username','email','firstname','lastname','DOB',"image_field",'is_admin','password','verified'] 
        # fields=['username','email','firstname','lastname','DOB',"image_field",'is_admin','password','password2','verified',]
        # ertra_fields={
    ...
    #     image_field=ImageEncode(validated_data.get('image_field'))
    #     # print(image_field)
    #     if image_field is None:
    #         raise serializers.ValidationError("Emage Field is not null")
